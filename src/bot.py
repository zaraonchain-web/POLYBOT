...
class TradingBot:
    ...
    def _init_clients(self) -> None:
        ...
        # FIX: Pass signer_address at construction time if signer is already
        # available (e.g. when api_creds are loaded from file rather than
        # derived). This ensures POLY_ADDRESS is correct from the first request.
